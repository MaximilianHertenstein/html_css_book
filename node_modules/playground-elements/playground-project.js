...
let PlaygroundProject = class PlaygroundProject extends LitElement {
    ...
    async update(changedProperties) {
        ...
        if (changedProperties.has('cdnBaseUrl') &&
        ...
        const onMessage = (e) => {
            if (e.data.type === ACKNOWLEDGE_SW_CONNECTION) {
                ...
                if (e.data.version === serviceWorkerHash) {
                    ...
                    void this._serviceWorkerAPI.setFileAPI(proxy({
    ...
    async save() {
        ...
        void workerApi.compileProject((_b = this._files) !== null && _b !== void 0 ? _b : [], {
    ...
    async getCompletions(changeData) {
        ...
        if (!changeData.isRefinement) {
            const workerApi = await this._deferredTypeScriptWorkerApi.promise;
            const completionInfo = await workerApi.getCompletions(changeData.fileName, changeData.fileContent, tokenUnderCursorAsString, changeData.cursorIndex, {
                importMap: this._importMap,
