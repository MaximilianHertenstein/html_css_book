 ...
 */
export declare class RegisterCodemirrorExtensionEvent extends Event {
 ...
 * Does not bubble.
 */
export declare class CodemirrorExtensionRegisteredEvent extends Event {
 ...
 * Does not bubble.
 */
export declare class PlaygroundEditorReadyEvent extends Event {
 ...
 */
export declare const codemirrorExtensionMixin: <T extends Constructor<WithWcCallbacks>>(superClass: T) => {
    new (...args: any[]): {
        isRegistered: boolean;
        _unregister?: () => void;
        /**
...
export {};
//# sourceMappingURL=codemirror-extension-mixin.d.ts.map